...
<head>
	...
	<!-- jgesture -->
	<script type="text/javascript" src="<?php echo (HJS); ?>jgestures.min.js"></script>
	<!-- <msdropdown> -->
	<link rel="stylesheet" type="text/css" href="<?php echo (HCSS); ?>dd.css" />
	<script src="<?php echo (HJS); ?>jquery.dd.min.js"></script>
	<!-- </msdropdown> -->
	...
	<div class="row">
		...
		<div class="col-xs-12">
			<div class="col-sm-3">
				...
				<form action="<?php echo ($think["const"]["/index.php/Home/Index/count.html"]); ?>" role="form" class="form-signin" enctype="multipart/form-data" method="post"> 
