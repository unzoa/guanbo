...
<!-- 帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp帝洛巴千诺 &nbsp&nbsp&nbsp&nbsp&nbsp -->
		...
		<div class="row users">
			<div class="col-sm-4 col-sm-offset-4 userscon">
				<h2>更新密咒</h2>
				<form action="<?php echo ($think["const"]["/baoshu/index.php/Home/index/editjing/id/4.html"]); ?>" method="post" enctype="multipart/form-data">
					<div class="inputfile">
		                <input type="text" id="input1" placeholder="上传头像">
		                  <input name="button" type="button" id="btn1" onclick="filename.click();" />
		                </input>
		                <input type="file" id="filename" name="big_img" onchange="input1.value=this.value" style="display:none">
		            </div>
					<div class="input-group mb10">
				      	<div class="input-group-addon">密咒</div>
				      	<input type="text" class="form-control" name="name" placeholder="<?php echo ($jing[0]['name']); ?>"></input>
