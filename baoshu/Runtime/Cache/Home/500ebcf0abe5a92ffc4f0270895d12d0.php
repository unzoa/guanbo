...
<marquee class="" scrolldelay="300" style="background-color: #ffe84d;line-height: 45px; color: #000079;height: 45px;margin-top: -10px;"><?php echo ($gg); ?></marquee>
		...
		<div class="row users">
			<div class="col-sm-4 col-sm-offset-4 userscon">
				<h2>更新密咒</h2>
				<form action="<?php echo ($think["const"]["/index.php/Home/index/editjing/id/1.html"]); ?>" method="post" enctype="multipart/form-data">
					<div class="inputfile">
					...
					<div class="input-group mb10">
				      	...
				      	<input type="text" class="form-control" name="name" value="<?php echo ($jing[0]['name']); ?>"></input>
