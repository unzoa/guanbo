...
<script type="text/javascript">
	function getinarchiveformsubmit(){
		...
		else{document.getElementById('get-in-archive-form').submit();}
	}
</script>
<script type="text/javascript">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="http://psy-ipass.com/Jcrop/index.html?id=<?php echo (session('stid')); ?>">修改头像</a></li>
	...
	<div class="row">
		<div class="col-sm-4 col-sm-offset-4">
			<div class="get_in_archive">
				<form action="<?php echo U('Home/Index/get_in_archive');?>" method="post" id="get-in-archive-form">
					<h2>档案入口</h2>
					...
					<input type="button" class="btn btn-lg btn-primary btn-block" value="下一步" onclick="getinarchiveformsubmit()"></input>
				</form>
			</div>
		</div>
	</div>
