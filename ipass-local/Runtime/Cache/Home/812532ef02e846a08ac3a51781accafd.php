          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="/guanbo/ipass-local/Jcrop/index.html?id=<?php echo (session('stid')); ?>">修改头像</a></li>
			...
			<div class="left_con2">
				<div class="row">
					<div class="col-sm-2 child_head">
						<img src="http://psy-ipass.com/Jcropchild/<?php echo ($userpic2); ?>" class="img-rounded" style="width: 100px;height: 100px">
					</div>
					<div class="col-sm-10">
						<h2 class="archive_childname" style="color: #9aaabf;"><?php echo ($archive[0][name]); ?></h2>
						<div class="col-sm-9 archive_slogan">
							<i style="color: #9aaabf">i.P.A.S.S 小改变创造大不同
...
<br/>
<style>
	.infooter{position: fixed;bottom: 0px;width: 100%}
	@media (max-width:767px){
