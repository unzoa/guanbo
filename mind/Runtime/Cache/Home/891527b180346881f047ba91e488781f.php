...
<body>
    ...
    <div class="row h_banner">
        ...
        <div class="container h_content">
          <div class="row">
          <?php if(is_array($mpthree)): $i = 0; $__LIST__ = array_slice($mpthree,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="media h_psy_media">
                <a class="media-left" href="<?php echo U("Home/Web/mpthreedetail",array('id'=>$v['id']));?>">
