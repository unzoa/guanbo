...
<head>
    ...
    <meta name="keywords" content="瀚威,瀚威心理,心理咨询,心理治疗,心理辅导,咨询师培训,情绪管理,情感问题，婚姻家庭,多动症,抑郁,焦虑,厌学,心理测试,失眠,沙盘游戏,催眠,解梦,压力管理,身心反馈,认知治疗,精神分析,家庭治疗,意象对话,危机干预">
	<!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
	<title>瀚威心理-主页</title>
    <link rel="icon" href="/mind/favicon.ico">
...
<!-- end --></div>
        ...
        <section class="intro p0">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="width: 100%">
                <ol class="carousel-indicators h_c_i" >
                ...
                <div class="carousel-inner" role="listbox">
                    <?php if(is_array($banner)): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!-- <div class='item <?php if($i == 1): ?>active<?php endif; ?>'>
						<img src="<?php echo (IMG_UPLOAD); echo ($v["img"]); ?>" style="width:100%">
						<div class="carousel-caption"></div>
                    </div> -->
                    <div class='item <?php if($i == 1): ?>active<?php endif; ?>' style="background-image: url('<?php echo (IMG_UPLOAD); echo ($v["img"]); ?>');background-size: cover;background-position: center;height: 550px">
		...
		<!-- ========= news =========== -->
        <section class="h_news_sec">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 h_news_colmartop">
                        <h3>瀚威动态</h3>
                        <ul class="h_news_ul">
                            <?php if(is_array($hnews)): $i = 0; $__LIST__ = $hnews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                <div class="media">
                                    <a href="<?php echo U("Home/Web/newsdetail",array('id'=>$v['id']));?>" class="media-left" >
                                        <div class="h_news_imgcon">
                                            <img src="<?php echo (IMG_UPLOAD); echo ($v["cover"]); ?>" alt="">
                                        </div>
                                    </a>
                                    <div class="media-body h_new_neirongcon">
                                        <p class="h_news_title"><?php echo ($v["title"]); ?></p>
                                        <p class="h_news_intro"><?php echo ($v["intro"]); ?></p>
                                    </div>
                                </div>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                        <a href="<?php echo U("Home/Web/news");?>" class="h_news_more"><i class="lnr lnr-magic-wand " aria-hidden="true"> 更 多</i></a>
                    </div>
                    <div class="col-sm-6 h_news_colmartop">
                        <h3>热点文章</h3>
                        <ul class="h_news_ul">
                            <?php if(is_array($hnewst)): $i = 0; $__LIST__ = $hnewst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                <div class="media">
                                    <a href="<?php echo U("Home/Web/newstdetail",array('id'=>$v['id']));?>" class="media-left" >
                                        <div class="h_news_imgcon">
                                            <img src="<?php echo (IMG_UPLOAD); echo ($v["cover"]); ?>" alt="">
                                        </div>
                                    </a>
                        ...
                        <a href="<?php echo U("Home/Web/newst");?>" class="h_news_more"><i class="lnr lnr-magic-wand " aria-hidden="true"> 更 多</i></a>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row">
                            <?php if(is_array($service)): $i = 0; $__LIST__ = array_slice($service,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-4 col-sm-6 col-xs-6 mt15">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12 p-l-r-0">
                        <div id="about" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <?php if(is_array($aboutus)): $i = 0; $__LIST__ = $aboutus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class='item <?php if($i == 1): ?>active<?php endif; ?>' style="background-image: url(<?php echo (IMG_UPLOAD); echo ($v["img"]); ?>);background-size:cover; background-position: center;">
