...
<body>
        ...
        <!--======== end =========-->
        <!-- ============banner========== -->
        <?php if(is_array($experttop)): $i = 0; $__LIST__ = $experttop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="h_e_banner" style="background-image: url('<?php echo (IMG_UPLOAD); echo ($v["img"]); ?>'); background-size: cover; background-position: center;">
        ...
        <div class="container what-we-do">
          <div class="row">
            <?php if(is_array($expert)): $i = 0; $__LIST__ = array_slice($expert,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-4 col-sm-6 col-xs-12">
