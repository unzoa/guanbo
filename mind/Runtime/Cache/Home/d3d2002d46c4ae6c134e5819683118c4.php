...
<!-- end --></div>
        <!--======== end =========-->
        <!-- ============banner========== -->
        <?php if(is_array($machinetop)): $i = 0; $__LIST__ = $machinetop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div style="position: relative;">
        ...
        <div class="container h_content">
          <div class="row">
          <?php if(is_array($machine)): $i = 0; $__LIST__ = array_slice($machine,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-4 col-sm-6 col-xs-12 h_news_news_con">
				<div class="h_news_news_con_con">
                    <a href="<?php echo U("Home/Web/machinedetail",array('id'=>$v['id']));?>">
                      <p class="h_news_news_title"><?php echo ($v["chtitle"]); ?></p>
                    </a>
                    <a href="<?php echo U("Home/Web/machinedetail",array('id'=>$v['id']));?>">
                      <div class="h_news_news_cover" style="background-image: url('<?php echo (IMG_UPLOAD); echo ($v["img"]); ?>');background-position: center;background-size: cover;">
                      </div>
                    </a>
