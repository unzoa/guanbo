...
<!-- end --></div>
        <!--======== end =========-->
        <!-- ============banner========== -->
        <?php if(is_array($servicetop)): $i = 0; $__LIST__ = $servicetop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="h_e_banner" style="background-image: url('<?php echo (IMG_UPLOAD); echo ($v["img"]); ?>'); background-size: cover; background-position: center;">
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
        <!-- ===========end============ -->
        ...
        <div class="container h_content">
          <div class="row h_detail">
          	<div class="col-xs-12">
            <div class="col-sm-10"><h1><?php echo ($info["chalt"]); ?></h1><p><?php echo ($info["engalt"]); ?></p></div>
            <div class="col-sm-2"><a href="<?php echo U('Home/Web/service');?>" class="h_sd_back">< 返回</a></div>
           	</div>
