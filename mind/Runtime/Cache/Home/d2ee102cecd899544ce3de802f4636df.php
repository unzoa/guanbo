...
<!-- end --></div>
        <!--======== end =========-->
        <!-- ============banner========== -->
        <?php if(is_array($psytop)): $i = 0; $__LIST__ = $psytop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div style="position: relative;">
          ...
          <div class="h_banner_text">
            <h1>心理咨询</h1>
            <h3><i>Psychological Consultation</i></h3>
          </div>
        ...
        <div class="container h_content">
          <div class="row">
          <?php if(is_array($psy)): $i = 0; $__LIST__ = array_slice($psy,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-3 col-sm-6 col-xs-12 h_news_news_con">
				<div class="h_news_news_con_con">
                    <a href="<?php echo U("Home/Web/psydetail",array('id'=>$v['id']));?>">
