...
<body>
        ...
        <!--======== end =========-->
        <!-- ============banner========== -->
        <?php if(is_array($machinetop)): $i = 0; $__LIST__ = $machinetop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="h_e_banner" style="background-image: url('<?php echo (IMG_UPLOAD); echo ($v["img"]); ?>'); background-size: cover; background-position: center;">
        ...
        <div class="container what-we-do">
          <div class="row">
          <?php if(is_array($machine)): $i = 0; $__LIST__ = array_slice($machine,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="media h_psy_media">
                <a class="media-left" href="<?php echo U("Home/Web/machinedetail",array('id'=>$v['id']));?>">
