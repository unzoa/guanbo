...
<head>
  ...
  <title>沈阳瀚威心理咨询有限公司-M.P.3教学</title>
...
<!-- end --></div>
        <!--======== end =========-->
        <!-- ============banner========== -->
        <?php if(is_array($mpthreetop)): $i = 0; $__LIST__ = $mpthreetop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div style="position: relative;">
        ...
        <div class="container h_content">
          <div class="row">
          <?php if(is_array($mpthree)): $i = 0; $__LIST__ = array_slice($mpthree,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-4 col-sm-6 col-xs-12 h_news_news_con">
				<div class="h_news_news_con_con">
                    <a href="<?php echo U("Home/Web/mpthreedetail",array('id'=>$v['id']));?>">
