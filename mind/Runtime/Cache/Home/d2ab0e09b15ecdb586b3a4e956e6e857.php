...
<head>
  ...
  <title>沈阳瀚威心理咨询有限公司-i.P.A.S.S</title>
...
<!-- end --></div>
        <!--======== end =========-->
        <!-- ============banner========== -->
        <?php if(is_array($ipasstop)): $i = 0; $__LIST__ = $ipasstop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div style="position: relative;">
        ...
        <div class="container h_content">
          <div class="row">
          <?php if(is_array($ipass)): $i = 0; $__LIST__ = array_slice($ipass,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-3 col-sm-6 col-xs-12 h_news_news_con">
				<div class="h_news_news_con_con">
                    <a href="<?php echo U("Home/Web/ipassdetail",array('id'=>$v['id']));?>">
