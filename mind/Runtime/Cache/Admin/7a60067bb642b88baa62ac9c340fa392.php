...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/addexpert.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="name" placeholder="名字"></input>
				<textarea name="intro" style="width:100%;" placeholder="介绍"></textarea>
