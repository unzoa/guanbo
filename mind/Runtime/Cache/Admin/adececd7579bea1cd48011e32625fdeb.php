    		...
    		<div class="col-sm-10 col-sm-offset-1">
            	...
            	<table class="table table-hover text-center">
        			<tr>
           			...
           			<?php if(is_array($newsbg1)): $i = 0; $__LIST__ = $newsbg1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
			    			<td><?php echo ($v["id"]); ?></td>
            	...
            	[<a href="<?php echo U('Admin/Admin/addhnews');?>">+ 增加瀚威动态</a>]
        		<table class="table table-hover text-center">
        			<tr>
        				<td width="5%">序号</td>
        				<td width="25%">标题</td>
           			...
           			<?php if(is_array($news_info)): $i = 0; $__LIST__ = $news_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
			    			<td><?php echo ($v["id"]); ?></td>
			    			<td><?php echo ($v["title"]); ?></td>
			    			<td><img src="<?php echo (IMG_UPLOAD); echo ($v["cover"]); ?>" style="width: 100px"></td>
			    			<td>
			    				[<a href="<?php echo U("Admin/Admin/updhnews",array('id'=>$v['id']));?>">更新</a>]
			    				[<a href="<?php echo U("Admin/Admin/delhnews",array('id'=>$v['id']));?>">删除</a>]
			    			</td>
			    		</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			    	<tr>
			    		<td colspan="5">
						<div class="h_page"><?php echo ($news_show); ?></div></td>
			    	</tr>
			    </table>
    		</div>
    	</div>
