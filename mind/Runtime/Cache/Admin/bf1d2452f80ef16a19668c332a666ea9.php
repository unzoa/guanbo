...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/addservice.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="engalt" placeholder="英文名字"></input> 
				<input type="text" name="chalt" placeholder="中文名字"></input>
				<script type="text/javascript" src="<?php echo (U_); ?>ueditor.config.js"></script>
				<script type="text/javascript" src="<?php echo (U_); ?>ueditor.all.js"></script>
				...
				<input type="text" name="url" placeholder="输入链接"></input> 
