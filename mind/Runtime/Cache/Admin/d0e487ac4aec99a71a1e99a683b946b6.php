...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/updmpthree/id/2.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="engtitle" value="<?php echo ($info["engtitle"]); ?>"></input> 
				<input type="text" name="chtitle" value="<?php echo ($info["chtitle"]); ?>"></input>
				<script type="text/javascript" src="<?php echo (U_); ?>ueditor.config.js"></script>
				<script type="text/javascript" src="<?php echo (U_); ?>ueditor.all.js"></script>
				...
				<textarea name="intro" style="width:100%;"><?php echo ($info["intro"]); ?></textarea>
