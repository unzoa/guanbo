...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/addbanner.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="alt" placeholder="备注"></input>
