...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/addyoulian.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="name" placeholder="网站名称"></input>
				<input type="text" name="url" placeholder="网站链接"></input>
