...
<body>
<div class="header" style="margin-top:-20px"><span><a href="<?php echo U('index.php/Admin/Admin/index');?>" style="color: #fff;">< 首页</a></span></div>
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/updbnews/id/4.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="title" value="<?php echo ($info["title"]); ?>"></input>
