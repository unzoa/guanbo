...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/h_wei/hw/Admin/Admin/addexpert.html"]); ?>" enctype="multipart/form-data" method="post"> 
				...
				<textarea name="intro" style="width:100%;"></textarea>
