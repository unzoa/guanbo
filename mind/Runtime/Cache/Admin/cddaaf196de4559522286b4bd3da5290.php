...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/updtop/id/1.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="phone" value="<?php echo ($info["phone"]); ?>"></input>
				<input type="text" name="time" value="<?php echo ($info["time"]); ?>"></input>
				<input type="text" name="email" value="<?php echo ($info["email"]); ?>"></input>
