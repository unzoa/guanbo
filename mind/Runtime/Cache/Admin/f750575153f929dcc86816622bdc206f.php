...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/updjudgebg/id/1.html"]); ?>" enctype="multipart/form-data" method="post">
				<img src="<?php echo (IMG_UPLOAD); echo ($info["img"]); ?>" style="width: 500px"> 
				<input type="file" name="img"></input>
				<input type="text" name="alt" value="<?php echo ($info["alt"]); ?>"></input><label>备注</label><br/>
