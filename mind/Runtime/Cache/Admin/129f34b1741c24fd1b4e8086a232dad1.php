...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/addbnews.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="title" placeholder="标题"></input>
				<textarea name="content" style="width:100%;"></textarea>
				<input type="text" name="url" placeholder="链接"></input>
