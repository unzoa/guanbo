	    		...
	    		<div class="col-sm-10 col-sm-offset-1">
			        ...
			        <div class="collapse-card">
			            <div class="collapse-card__heading">
			                <a href="<?php echo U('Admin/Admin/news');?>" style="color: inherit;">
			        ...
			        <div class="collapse-card">
			            <div class="collapse-card__heading">
			                <a href="<?php echo U('Admin/Admin/newst');?>" style="color: inherit;">
			                <h4 class="collapse-card__title">
			                    <i class="fa fa-newspaper-o fa-2x fa-fw"></i>
			                   	行业新闻
			                </h4></a>
			        ...
			        <div class="collapse-card">
			            ...
			            <div class="collapse-card__body">
			            	[<a href="<?php echo U('Admin/Admin/addbanner');?>">增加Banner</a>]
			        ...
			        <div class="collapse-card">
			            ...
			            <div class="collapse-card__body">
			            	...
			            	<hr/>
			            	[<a href="<?php echo U('Admin/Admin/addjudge');?>">增加反馈</a>]
			            		<table class="table table-hover text-center">
			            			<tr>
			            				<td width="5%">排序</td>
			            				<td width="65%">评价</td>
			        ...
			        <div class="collapse-card">
			            ...
			            <div class="collapse-card__body">
			            	[<a href="<?php echo U('Admin/Admin/addus');?>">增加</a>]
			        ...
			        <div class="collapse-card  mt15">
			            ...
			            <div class="collapse-card__body">
			            	[<a href="<?php echo U('Admin/Admin/addexpert');?>">增加</a>]
			            		<table class="table table-hover text-center">
			            			<tr>
			            				<td >排序</td>
			            				<td >名字</td>
			        ...
			        <div class="collapse-card">
			            ...
			            <div class="collapse-card__body">
			            	[<a href="<?php echo U('Admin/Admin/addservice');?>">增加</a>]
			            		<table class="table table-hover text-center">
			            			<tr>
			            				<td>排序</td>
			            				<td>英文名字</td>
