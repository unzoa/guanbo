...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form method="post" action="<?php echo ($think["const"]["/index.php/Admin/Admin/updcate/id/18.html"]); ?>" enctype="multipart/form-data">
				<h1>更新栏目分类</h1>
				<input name="title" type="text" value="<?php echo ($info["title"]); ?>"></input><label>添加分类名称</label><br/>
				<input type="text" name="url" value="<?php echo ($info["url"]); ?>"></input><label>添加链接</label><br/>
				<input name="sort" type="text" value="<?php echo ($info["sort"]); ?>"></input><label>排序</label><br/>
