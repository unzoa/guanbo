...
<div class="container mt10">
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<form action="<?php echo ($think["const"]["/index.php/Admin/Admin/addjudge.html"]); ?>" enctype="multipart/form-data" method="post"> 
				<input type="text" name="name" placeholder="客户名字"></input>
				<textarea name="judge" placeholder="客户评论" style="width:100%;"></textarea>
