...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- <form class="form-signin" method="POST" action="<?php echo ($think["const"]["/hanwei/hw/index.php/Admin/Atest/register"]); ?>">
      ...
      <form method="post" action="<?php echo ($think["const"]["/hanwei/hw/index.php/Admin/Atest/register"]); ?>">
